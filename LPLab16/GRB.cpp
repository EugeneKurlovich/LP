...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,
		Rule(NS('S'), GRB_ERROR_SERIES, 4,   //  —труктура программы
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 7,  // возможные конструкции в ф-и€х
			Rule::Chain(5, TS('d'), TS('t'), TS('i'), TS(';'), NS('N')),
			Rule::Chain(7, TS('d'), TS('t'), TS('i'), TS('='), NS('E'), TS(';'), NS('N')),
			Rule::Chain(5, TS('i'), TS('='), NS('E'), TS(';'), NS('N')),
			Rule::Chain(8, TS('t'), TS('f'), TS('a'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(8, TS('t'), TS('f'), TS('s'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(4, TS('p'), NS('E'), TS(';'), NS('N')),
			Rule::Chain(3, TS('r'), NS('E'), TS(';'))
		),
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 9, // выражени€
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
		...
		Rule(NS('M'), GRB_ERROR_SERIES + 5, 6, // знаки
